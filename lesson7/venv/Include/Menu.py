...
class Menu():
    ...
    def initilize(self):
        ...
        self.btnRestart=Menu_ButtonItem(name="button1",text="Restart",width=200,height=50,textSize=50,mainColor=(220,20,60),onMouseOverColor= (0,205,205),centerlocation=(self.screenrect.center[0],self.screenrect.center[1]-100))
        ...
        self.btnExit=Menu_ButtonItem(name="button3",text="exit",width=100,height=50,textSize=50,mainColor=(220,20,60),onMouseOverColor= (0,205,205),centerlocation=(self.screenrect.center[0],self.screenrect.center[1]))
